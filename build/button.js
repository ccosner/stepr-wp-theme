...
function Edit(props) {
  ...
  const currentColorValue = _inc_theme__WEBPACK_IMPORTED_MODULE_4__.buttonStyles.filter(color => {
  ...
  function handleColorChange(newValue) {
    if (newValue !== undefined) {
      const {
        name
      } = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.getColorObjectByColorValue)(_inc_theme__WEBPACK_IMPORTED_MODULE_4__.buttonStyles, newValue);
      setAttributes({
        buttonStyle: name
      });
    } else {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
    ...
    clearable: false,
    colors: _inc_theme__WEBPACK_IMPORTED_MODULE_4__.buttonStyles,
    ...
    isPressed: isLinkPickerVisible,
    onClick: () => setIsLinkPickerVisible(state => !state),
